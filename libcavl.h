...
/* TODO function descriptions and return values */
...
int		 tree_justdelnode(struct tree *t, struct treenode *n);
int		 tree_height(struct tree *);
int		 tree_balance(struct tree *);
int		 treenode_balance(struct treenode *);
